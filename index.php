                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" name="responsible" value="" placeholder="Ответсвенный">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="task" value="" placeholder="Задача">
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control" name="date" value="" placeholder="Дата">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="status" value="" placeholder="Статус">
                        </div>
                </div>
